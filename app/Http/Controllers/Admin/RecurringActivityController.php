...
class RecurringActivityController extends Controller
{
    public function index()
    {
        ...
        return view('admin.recurringActivities.index', compact('recurringActivities'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.recurringActivities.create', compact('tasks', 'users'));
    }
    ...
    public function store(StoreRecurringActivityRequest $request)
    {
        ...
        return redirect()->route('admin.recurring-activities.index');
    }
    ...
    public function edit(RecurringActivity $recurringActivity)
    {
        ...
        return view('admin.recurringActivities.edit', compact('recurringActivity', 'tasks', 'users'));
    }
    ...
    public function show(RecurringActivity $recurringActivity)
    {
        ...
        return view('admin.recurringActivities.show', compact('recurringActivity'));
    }
