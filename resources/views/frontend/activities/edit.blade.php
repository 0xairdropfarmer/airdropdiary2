                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.activities.update", [$activity->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_interact" id="total_interact" value="{{ old('total_interact', $activity->total_interact) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $activity->total_amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_gas_spend" id="total_gas_spend" value="{{ old('total_gas_spend', $activity->total_gas_spend) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Activity::DONE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="done_{{ $key }}" name="done" value="{{ $key }}" {{ old('done', $activity->done) === (string) $key ? 'checked' : '' }}>
