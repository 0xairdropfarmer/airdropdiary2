                    ...
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Project::LIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="live_{{ $key }}" name="live" value="{{ $key }}" {{ old('live', $project->live) === (string) $key ? 'checked' : '' }}>
                                    <label for="live_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                            @if($errors->has('live'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Project::AIRDROPCF_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="airdropcf_{{ $key }}" name="airdropcf" value="{{ $key }}" {{ old('airdropcf', $project->airdropcf) === (string) $key ? 'checked' : '' }}>
                                    <label for="airdropcf_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="raisefund" id="raisefund" value="{{ old('raisefund', $project->raisefund) }}" step="1">
