                    ...
                    <form method="POST" action="{{ route("frontend.projects.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Project::LIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="live_{{ $key }}" name="live" value="{{ $key }}" {{ old('live', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Project::AIRDROPCF_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="airdropcf_{{ $key }}" name="airdropcf" value="{{ $key }}" {{ old('airdropcf', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="raisefund" id="raisefund" value="{{ old('raisefund', '0') }}" step="1">
