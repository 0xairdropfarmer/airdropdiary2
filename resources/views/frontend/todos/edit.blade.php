                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.todos.update", [$todo->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="due_date" id="due_date" value="{{ old('due_date', $todo->due_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Todo::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $todo->status) === (string) $key ? 'checked' : '' }}>
