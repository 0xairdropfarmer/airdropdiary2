                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expire_at" id="expire_at" value="{{ old('expire_at', $user->expire_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="wallet_address" id="wallet_address" value="{{ old('wallet_address', $user->wallet_address) }}">
