                    ...
                    <form method="POST" action="{{ route("frontend.tasks.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Task::TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Task::PHASE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="phase_{{ $key }}" name="phase" value="{{ $key }}" {{ old('phase', '') === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract_address" id="contract_address" value="{{ old('contract_address', '') }}">
