                    ...
                    <form method="POST" action="{{ route("frontend.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Task::TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', $task->type) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Task::PHASE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="phase_{{ $key }}" name="phase" value="{{ $key }}" {{ old('phase', $task->phase) === (string) $key ? 'checked' : '' }}>
                                    <label for="phase_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
                            @if($errors->has('phase'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="expire_date" id="expire_date" value="{{ old('expire_date', $task->expire_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contract_address" id="contract_address" value="{{ old('contract_address', $task->contract_address) }}">
