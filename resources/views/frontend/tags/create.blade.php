            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tags.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="logo">{{ trans('cruds.tag.fields.logo') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.tag.fields.logo_helper') }}</span>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    url: '{{ route('frontend.tags.storeMedia') }}',
    maxFilesize: 2, // MB
