...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.update", [$category->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cover">{{ trans('cruds.category.fields.cover') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('blockscan_url') ? 'is-invalid' : '' }}" type="text" name="blockscan_url" id="blockscan_url" value="{{ old('blockscan_url', $category->blockscan_url) }}">
