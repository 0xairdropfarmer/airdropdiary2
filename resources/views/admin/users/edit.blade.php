    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wallet_address') ? 'is-invalid' : '' }}" type="text" name="wallet_address" id="wallet_address" value="{{ old('wallet_address', $user->wallet_address) }}">
